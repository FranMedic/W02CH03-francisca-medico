...
const questions = [
  {
    letra: "a",
    status: 0,
    respuesta: { 1: "albondiga", 2: "alegria", 3: "arbol" },
    preguntas: {
      1: "Con la A: Bola pequeña hecha de carne o pescado picados y mezclados con huevo, pan rallado y especias que se reboza en harina, se fríe y generalmente después se cocina con una salsa; se sirven varias por ración",
...

  {
    letra: "b",
    status: 0,
    respuesta: { 1: "balon", 2: "boca", 3: "bombon" },
    preguntas: {
      1: "Con la B: Pelota grande llena de aire que se utiliza para jugar o para practicar determinados deportes.",
...

  {
    letra: "c",
    status: 0,
    respuesta: { 1: "casa", 2: "coche", 3: "carton" },
    preguntas: {
      1: "Con la C: Edificio o parte de él que constituye una vivienda particular.",
...

  {
    letra: "d",
    status: 0,
    respuesta: { 1: "dedo", 2: "dublin", 3: "disco" },
    preguntas: {
      1: "Con la D: Parte alargada en que terminan la mano y el pie de los vertebrados.",
...

  {
    letra: "e",
    status: 0,
    respuesta: { 1: "estomago", 2: "escuela", 3: "empeñar" },
    preguntas: {
      1: "Con la E: Ensanchamiento del tubo digestivo del hombre y otros animales situado entre el esófago y el intestino, en cuyas paredes están las glándulas que segregan los jugos gástricos que intervienen en la digestión.",
...

  {
    letra: "f",
    status: 0,
    respuesta: { 1: "fuego", 2: "fantasma", 3: "fanfarria" },
    preguntas: {
      1: "Con la F: Emisión de luz y calor producida por la combustión de una materia.",
...

  {
    letra: "g",
    status: 0,
    respuesta: { 1: "gato", 2: "goma", 3: "guantes" },
    preguntas: {
      1: "Con la G: Mamífero felino de tamaño generalmente pequeño, cuerpo flexible, cabeza redonda, patas cortas, cola larga, pelo espeso y suave, largos bigotes y uñas retráctiles; es carnívoro y tiene gran agilidad, buen olfato, buen oído y excelente visión nocturna; existen muchas especies diferentes.",
...

  {
    letra: "h",
    status: 0,
    respuesta: { 1: "hotel", 2: "hablar", 3: "huevo" },
    preguntas: {
      1: "Con la H: Establecimiento de hostelería que ocupa un edificio total o parcialmente con uso exclusivo de sus servicios (entradas, ascensores, escaleras, etc.) y que ofrece alojamiento y servicio de comedor.",
...

  {
    letra: "i",
    status: 0,
    respuesta: { 1: "instagram", 2: "ikea", 3: "incordiar" },
    preguntas: {
      1: "Con la I: Aplicación y red social de origen estadounidense, propiedad de Facebook, cuya función principal es poder compartir fotografías y vídeos con otros usuarios.",
...

  {
    letra: "j",
    status: 0,
    respuesta: { 1: "jamon", 2: "joroba", 3: "jueves" },
    preguntas: {
      1: "Con la J: Pata trasera de cerdo, cruda o curada, que se destina al consumo alimenticio; también puede ser de otros animales.",
...

  {
    letra: "k",
    status: 0,
    respuesta: { 1: "kamikaze", 2: "kyoto", 3: "karate" },
    preguntas: {
      1: "Con la K: Avión suicida del ejército japonés que en la Segunda Guerra Mundial se estrellaba voluntariamente cargado de explosivos contra el objetivo enemigo.",
...

  {
    letra: "l",
    status: 0,
    respuesta: { 1: "luz", 2: "larva", 3: "luna" },
    preguntas: {
      1: "Con la L: Forma de energía que ilumina las cosas, las hace visibles y se propaga mediante partículas llamadas fotones.",
...

  {
    letra: "m",
    status: 0,
    respuesta: { 1: "milagro", 2: "morcilla", 3: "marciano" },
    preguntas: {
      1: "Con la M: Suceso extraordinario y maravilloso que no puede explicarse por las leyes regulares de la naturaleza y que se atribuye a la intervención de Dios o de un ser sobrenatural.",
...

  {
    letra: "n",
    status: 0,
    respuesta: { 1: "nieve", 2: "nuera", 3: "nuez" },
    preguntas: {
      1: "Con la N: Fenómeno meteorológico que consiste en la precipitación de pequeños cristales de hielo.",
...

  {
    letra: "o",
    status: 0,
    respuesta: { 1: "ombligo", 2: "ordeñar", 3: "ostra" },
    preguntas: {
      1: "Con la O: Cicatriz redondeada y arrugada que se forma en medio del vientre tras cortar y secarse el cordón umbilical.",
...

  {
    letra: "p",
    status: 0,
    respuesta: { 1: "patata", 2: "puerta", 3: "pomelo" },
    preguntas: {
      1: "Con la P: Tubérculo comestible, muy carnoso, de forma redonda o alargada y de color marrón por fuera y blanco o amarillo por dentro.",
...

  {
    letra: "q",
    status: 0,
    respuesta: { 1: "queso", 2: "quilla", 3: "quimica" },
    preguntas: {
      1: "Con la Q: Alimento sólido que se obtiene por maduración de la cuajada de la leche una vez eliminado el suero.",
...

  {
    letra: "r",
    status: 0,
    respuesta: { 1: "regalo", 2: "robot", 3: "rueda" },
    preguntas: {
      1: "Con la R: Cosa que se da a una persona como muestra de afecto o de consideración.",
...

  {
    letra: "s",
    status: 0,
    respuesta: { 1: "serpiente", 2: "silbido", 3: "suecia" },
    preguntas: {
      1: "Con la S: Reptil sin extremidades, de cuerpo muy alargado y estrecho, con la cabeza aplastada, la boca grande y la piel escamosa; se aplica este nombre especialmente a los de gran tamaño; hay especies terrestres y especies acuáticas.",
...

  {
    letra: "t",
    status: 0,
    respuesta: { 1: "tetera", 2: "tuetano", 3: "tuerto" },
    preguntas: {
      1: "Con la T: Recipiente para preparar y servir el té, con una tapadera y un pitorro para verterlo.",
...

  {
    letra: "u",
    status: 0,
    respuesta: { 1: "uva", 2: "universidad", 3: "urraca" },
    preguntas: {
      1: "Con la U:Fruto de la vid, comestible, pequeño y de forma redonda u ovalada, piel muy fina y carne muy jugosa; nace junto a otros formando racimos.",
...

  {
    letra: "v",
    status: 0,
    respuesta: { 1: "victima", 2: "vagon", 3: "vacuna" },
    preguntas: {
      1: "Con la V: Persona o animal que sufre un daño o un perjuicio a causa de determinada acción o suceso.",
...

  {
    letra: "w",
    status: 0,
    respuesta: { 1: "watio", 2: "wasabi", 3: "wikipedia" },
    preguntas: {
      1: "Con la W: Unidad de potencia, de símbolo W, que equivale a la potencia capaz de conseguir la producción de energía igual a 1 julio por segundo.",
...

  {
    letra: "y",
    status: 0,
    respuesta: { 1: "yate", 2: "yedra", 3: "yunque" },
    preguntas: {
      1: "Con la Y: Embarcación de recreo a motor o a vela, de manga o anchura mayor que un velero, con camarotes y generalmente lujosa.",
...

  {
    letra: "z",
    status: 0,
    respuesta: { 1: "zoo", 2: "zapato", 3: "zigzag" },
    preguntas: {
      1: "Con la Z: Recinto con instalaciones adecuadas para conservar, cuidar y criar especies diferentes de animales, especialmente salvajes y exóticos, que puede ser visitado por el público.",
...
function pasapalabra() {
  ...
  let cuantosAciertos;
  let cuantosErrores;
  const preguntaRandom = Math.floor(Math.random() * 3) + 1;
  const turnos = [];

  const jugadores = [
    { name: "Arthas", turns: 28 },
    { name: "Illidan", turns: 32 },
    { name: "kaelthas", turns: 35 },
    { name: "guldan", turns: 50 },
  ];
  ...
  do {
    ...
    for (let i = 0; i < questions.length; i++) {
      if (questions[i].status === 0 || questions[i].status === "pasa") {
        ...
        if (respuesta === null) {
          ...
          respuestaDef = respuesta.toLowerCase();
        }
    ...
    cuantosErrores = 0;
    for (let i = 0; i < questions.length; i++) {
      if (questions[i].status === "mala") cuantosErrores++;
    }
    cuantosAciertos = 0;
    for (let i = 0; i < questions.length; i++) {
      if (questions[i].status === "buena") cuantosAciertos++;
    }
    cuantosPasa = 0;
    for (let i = 0; i < questions.length; i++) {
      if (questions[i].status === "pasa") cuantosPasa++;
    }
  ...
  for (let i = 0; i < jugadores.length; i++) {
    console.log(
      `Nombre: ${jugadores[i].name}, su puntuación ha sido ${jugadores[i].puntos}`
    );
  }
